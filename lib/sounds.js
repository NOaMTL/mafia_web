...
export const sounds = {
  ...
  /** Coup de marteau du juge — deux impacts secs. */
  gavel() {
    tone(95, { dur: 0.09, type: 'square', gain: 0.16 });
    tone(70, { t: 0.02, dur: 0.16, type: 'sine', gain: 0.14 });
    tone(95, { t: 0.32, dur: 0.09, type: 'square', gain: 0.13 });
    tone(70, { t: 0.34, dur: 0.2, type: 'sine', gain: 0.12 });
  },

  /** Souffle de transition de phase. */
  whoosh() {
    tone(520, { dur: 0.5, type: 'sine', gain: 0.045, glideTo: 130, channel: 'ambience' });
    tone(260, { t: 0.05, dur: 0.6, type: 'triangle', gain: 0.03, glideTo: 65, channel: 'ambience' });
  },
