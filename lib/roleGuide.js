...
export const ROLE_GUIDE = [
  ...
  {
    key: 'GODFATHER', name: 'Parrain', team: 'MAFIA', emoji: '🎩', color: '#8e44ad',
    description:
  ...
  {
    key: 'ESCORT', name: 'Escorte', team: 'VILLAGE', emoji: '💃', color: '#e91e63',
    description:
  ...
  {
    key: 'CONSIGLIERE', name: 'Consigliere', team: 'MAFIA', emoji: '🕵️', color: '#c0392b',
    description:
