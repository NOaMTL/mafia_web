...
export const ROLE_GUIDE = [
  ...
  role('MAYOR', 'Maire', 'TOWN', '🏛️', '#cf9f43', 'Peut révéler sa fonction afin que chacun de ses votes compte pour trois voix.', null, 'Révèle-toi lorsque ton influence change réellement le verdict.'),
...
export const PHASE_GUIDE = [
  ...
  { name: 'Vote', emoji: '🗳️', tone: 'day',
    description: 'La ville désigne un suspect à envoyer au procès. Les votes sont publics et nominatifs. En cas d’égalité, personne n’est jugé. Le vote d’un Maire révélé compte triple.',
...
export const ROLE_MECHANICS = {
  ...
  MAYOR: [
    fact('🏛️', 'EFFET', 'Une fois révélé, votre vote compte TRIPLE, définitivement. La révélation est publique et irréversible.'),
