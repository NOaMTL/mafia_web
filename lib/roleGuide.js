...
export const ROLE_GUIDE = [
  {
    key: 'VILLAGER', name: 'Villageois', team: 'VILLAGE', emoji: '🏘️', color: '#8d8d8d',
    description:
  ...
  {
    key: 'MAFIA', name: 'Mafioso', team: 'MAFIA', emoji: '🔪', color: '#d84b3c',
    description:
  ...
  {
    key: 'DETECTIVE', name: 'Détective', team: 'VILLAGE', emoji: '🔍', color: '#2a8fcd',
    description:
  ...
  {
    key: 'DOCTOR', name: 'Médecin', team: 'VILLAGE', emoji: '⚕️', color: '#219253',
    description:
  ...
  {
    key: 'MEDIUM', name: 'Médium', team: 'VILLAGE', emoji: '🔮', color: '#a76bc4',
    description:
  ...
  {
    key: 'VIGILANTE', name: 'Vigilante', team: 'VILLAGE', emoji: '⚖️', color: '#cd7a1e',
    description:
  ...
  {
    key: 'GODFATHER', name: 'Parrain', team: 'MAFIA', emoji: '🎩', color: '#9c53c4',
    description:
  ...
  {
    key: 'ESCORT', name: 'Escorte', team: 'VILLAGE', emoji: '💃', color: '#d84a80',
    description:
  ...
  {
    key: 'CONSIGLIERE', name: 'Consigliere', team: 'MAFIA', emoji: '🕵️', color: '#d84b3c',
    description:
